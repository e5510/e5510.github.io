...
description: >-
  Here you can see all of Fire's commands. All of these examples use the default
  prefix, $
---
...
| np | Sends the music controller message which contains various information about the current and upcoming songs. | `$np` | now\_playing, current, currentsong |
...
| vanityurl | Creates a vanity invite for your Discord using [https://oh-my-god.wtf/](https://oh-my-god.wtf/) | `$vanityurl [<code>/"disable"]` |
